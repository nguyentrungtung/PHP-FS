<div class="d-flex flex-column header">
    <div class="d-flex justify-content-between align-items-center haeder_top" >
        <div class="d-flex align-items-center header_top_left">
            <img class="header_top_left_logo" src="{{ asset('client/img/layout/winm_logo.png') }}" alt="">
            ...
            <div id="cart" class="d-flex align-items-center header_top_right_cart">
                ...
                <div id="cart_list" class="cart_list hidden">
                        ...
                        <div class="d-flex list_items_item">
                            ...
                            <div class="d-flex flex-wrap flex-column item_content">
                                ...
                                <div class="d-flex justify-content-between item_content_price">
                                    <p class="item_content_text">x 2</p>
                                    <p class="item_price">79.800 VND</p>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex list_items_item">
                    ...
                    <div class="d-flex align-items-center justify-content-between cart_list_total">
                        <p class="total_text">Có tổng số: 4 sản phẩm</p>
        ...
        <div id="menu" class="d-flex align-items-center header_buttom_menu">
            ...
            <div id="menu_list" class="align-items-start menu_list hidden">
                <ul type="none" class="menu_list_ul">
                    <a href=""><li class="menu_list_ul_li">Siêu rẻ</li></a>
                    <a href=""><li class="menu_list_ul_li">Siêu Khuyến mãi</li></a>
                    <a href=""><li class="menu_list_ul_li">Ưu đãi hội viên</li></a>
                    <a href=""><li class="d-flex justify-content-between align-items-center menu_list_ul_li sub">Sữa các loại
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/>
                          </svg>
                    </li></a>
                    <a href=""><li class="menu_list_ul_li">Rau củ - Trái cây</li></a>
                    <a href=""><li class="menu_list_ul_li">Hóa phẩm - Tẩy rửa</li></a>
                    <a href=""><li class="menu_list_ul_li">Chăm sóc cá nhân</li></a>
                    <a href=""><li class="menu_list_ul_li">Thịt hải sản tươi</li></a>
                    <a href=""><li class="menu_list_ul_li">Bánh kẹo</li></a>
                    <a href=""><li class="menu_list_ul_li">Đồ uống có cồn</li></a>
                ...
                <div id="sub_list" class="menu_sub_list hidden">
                    <ul type="none" class="menu_list_ul">
                        ...
                        <a href=""><li class="menu_list_ul_li">Siêu Khuyến mãi</li></a>
                        <a href=""><li class="menu_list_ul_li">Ưu đãi hội viên</li></a>
                        <a href=""><li class="menu_list_ul_li">Sữa các loại</li></a>
                    </ul>
