...
var originalNameProduct = document.getElementById('product_name--detail').innerText;
function changePrice(value, ob) {
    document.getElementById('product_name--detail').innerText = originalNameProduct + ' - ' + ob.innerText;
